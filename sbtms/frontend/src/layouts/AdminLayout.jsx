  ...
  return (
    <div className="min-h-screen flex bg-slate-100">
      <aside className="w-60 bg-gradient-to-b from-slate-900 to-slate-800 text-white p-4 flex flex-col">
        <h1 className="text-lg font-bold mb-6">🚌 SBTMS Admin</h1>
        <nav className="space-y-1 flex-1">
          <NavLink to="/admin" end className={item}>Dashboard</NavLink>
          <NavLink to="/admin/buses" className={item}>Buses</NavLink>
          <NavLink to="/admin/drivers" className={item}>Drivers</NavLink>
          <NavLink to="/admin/routes" className={item}>Routes</NavLink>
          <NavLink to="/admin/schedules" className={item}>Schedules</NavLink>
          <NavLink to="/admin/bookings" className={item}>Bookings</NavLink>
          <NavLink to="/admin/reports" className={item}>Reports</NavLink>
        </nav>
